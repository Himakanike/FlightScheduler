...
class FlightScheduler{
	...
	*/
	...
	input.readAirports("C:/Users/Asus/Desktop/FlightScheduler/FlightScheduler/airports.txt");
	System.out.println("Read " + input.airports.length + " airports");
	//input.readFlights(args[1]);
	input.readFlights("C:/Users/Asus/Desktop/FlightScheduler/FlightScheduler/flights.txt");
	...
	//findPaths(input, G, args[2]);
	    findPaths(input, G,"C:/Users/Asus/Desktop/FlightScheduler.tar (1)/FlightScheduler/FlightScheduler/query2.txt");
    }
	...
	Query queries[] = QueryReader.readQueries(queryFile);
		...
		System.out.println("fromap.name = " + fromap.name);
		for(int i=0; i<input.airports.length; i++){
			System.out.println("" + input.airports[i].name + ",  " + input.airports[i].id);
		}
//		
